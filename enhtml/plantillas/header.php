        ...
        <nav class="navbar-light navbar-toggleable-md bg-faded">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarContainer">
                    <!-- busqueda-->
                    <form id="search_mini_form" class="navbar-form float-right form-inline hidden-lg-up" method="get"
                        action="buscar">
                        <input type="text" value="" name="q" class="form-control form-control-sm" onFocus="javascript:this.value = ''"
                            placeholder="Buscar Carros" />
                        <button type="submit" class="btn btn-secondary btn-sm hidden-md"><i class="fa fa-search fa-fw"></i></button>
                    </form>
                    ...
                    <ul class="nav navbar-nav float-right nav-top">
                        ...
                        <li>
                            <a href="login.html" id="login-link" class="trsn nav-link" title="login">
                        ...
                        <li>
                            <a href="registroClientes.html" id="login-link" class="trsn nav-link" title="registro">
                                <i class="fa fa-user fa-fw"></i>
                                <span class="customer-name">
                                    Registrate
                                </span>
                    ...
                    <form id="search_mini_form" class="navbar-form float-right form-inline hidden-md" method="get"
                        action="buscar">
                        <input type="text" value="" name="q" class="form-control form-control-sm" onFocus="javascript:this.value = ''"
